...
public partial class PlayerPathfinder : CharacterBody2D
{
    ...
    [Export]
    public  float SmallJumpVelocity = -370.0f;
    [Export]
    public  float TinyJumpVelocity = -270.0f;
    ...
    private void GoToNextPointInPath()
    {
        ...
        if (_prevTarget != null)
        {
            ...
            _pathFind2D.AddVisualPoint(_pathFind2D.ConvertPointPositionToMapPosition(_target.Position), new Color(1, 0, 0, 1f), scale:0.75f, temp: true);
        }
    }
